...
//     description:
//       "Embark on a journey of knowledge discovery, and growth at Unipix University.",
//     image: "/assets/images/program/program__4.jpg",
//     link: "/program-single",
//   },
// ];
...
//           <Link
//             href="/program-single"
//             className="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-blue-600 rounded-md uppercase tracking-wider hover:bg-blue-700 transition-colors"
//           >
//             More Program
...
//             <div
//               key={index}
//               className="relative bg-cover bg-center bg-no-repeat h-96 rounded-lg shadow-md overflow-hidden group"
//               style={{ backgroundImage: `url(${program.image})` }}
//             >
//               {/* Overlay */}
//               <div className="absolute inset-0 bg-black/50 group-hover:bg-black/60 transition-colors" />
//               <div className="relative p-6 flex flex-col justify-end h-full z-10">
//                 <h5 className="text-xl font-semibold text-white font-heading mb-2">
//                   {program.title}
//                 </h5>
...
//                 <Link
//                   href={program.link}
//                   className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-md uppercase tracking-wider hover:bg-blue-700 transition-colors"
//                 >
//                   Learn More
//                   <ArrowRight className="w-4 h-4" />
//                 </Link>
