...
const galleryItems = [
  ...
  {
    id: 15,
    src: '/gallery/B2B_7934.jpg',
    alt: 'University life at Euston',
    title: 'Student Life',
    aspectRatio: '600/540',
  },
];
...
const MasonryGallery = () => {
  ...
  const slides = galleryItems.map((item) => ({
    src: item.src,
    alt: item.alt,
    description: item.title, // optional caption
  }));
